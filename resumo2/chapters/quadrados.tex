...
\begin{document}
	...
	\begin{figure}[H]
		...
		% por algum motivo essa legenda nao aparece
		% não é um grande problema, mas se alguem conseguir resolver isso
		% deixaria o texto um pouco mais bonito
		\centering
		\includegraphics[width=.5\linewidth]{trinomio.png}
